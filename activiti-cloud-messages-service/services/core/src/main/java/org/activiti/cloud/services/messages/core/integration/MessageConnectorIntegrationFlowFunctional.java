...
public class MessageConnectorIntegrationFlowFunctional extends IntegrationFlowAdapter {
    ...
    public MessageConnectorIntegrationFlowFunctional(MessageConnectorAggregator aggregator,
    ...
    protected IntegrationFlowDefinition<?> buildFlow() {
        return this.from(MessageConnectorIntegrationFlowProcessorFunction.class, gateway -> gateway.beanName("messageConnectorIntegrationFlowProcessor"))
                .headerFilter(properties.getInputHeadersToRemove())
                .gateway(flow -> flow.log(LoggingHandler.Level.INFO)
